  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="bg-gradient-to-b from-brand-50 to-white py-20 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg text-slate-600 mb-10">
            Tìm kiếm hướng dẫn, câu trả lời và tài liệu kỹ thuật cho CataPos.
          </p>
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-4 text-sm text-slate-500">
            <span>Phổ biến:</span>
            <Link to="/search?q=kết nối máy in" className="text-brand-600 hover:underline">Kết nối máy in</Link>
            <Link to="/search?q=tạo đơn hàng" className="text-brand-600 hover:underline">Tạo đơn hàng</Link>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full">
        <h2 className="text-2xl font-bold text-slate-900 mb-8">Khám phá theo chủ đề</h2>
            ...
            {categories.map((category) => (
              ...
              >
                ...
                <div className="flex items-center text-sm font-medium text-brand-600 mt-auto">
                  {category.articleCount} bài viết <Icons.ChevronRight className="w-4 h-4 ml-1 group-hover:translate-x-1 transition-transform" />
                </div>
              </Link>
            ))}
          </div>
      ...
      <div className="bg-slate-50 py-16 border-t border-slate-200">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-2xl font-bold text-slate-900 mb-4">Vẫn chưa tìm thấy câu trả lời?</h2>
          <p className="text-slate-600 mb-8">Đội ngũ hỗ trợ của chúng tôi luôn sẵn sàng giúp đỡ bạn.</p>
