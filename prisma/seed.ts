...
async function main() {
  ...
  const enCategories = await prisma.$transaction([
    ...
    prisma.category.create({
      data: {
        name: 'Store Settings',
        slug: 'store-settings',
        description: 'Printer, tax, and staff configuration guides',
        iconUrl: 'settings',
        sortOrder: 3,
        articleCount: 3,
        languageCode: 'en',
    ...
    prisma.category.create({
      data: {
        ...
        slug: 'api-docs',
        description: 'Technical integration docs for developers',
        iconUrl: 'code',
        sortOrder: 4,
        articleCount: 2,
        languageCode: 'en',
    ...
    data: [
      {
        ...
        type: 'USER_MANUAL',
        status: 'PUBLISHED',
        title: 'Connect a K80 thermal printer',
        slug: 'huong-dan-ket-noi-may-in-nhiet-k80',
        summary:
          'Step-by-step guide to connect and configure a K80 thermal printer over LAN or USB.',
        content: [
          '# Connect a K80 thermal printer',
          '',
          '## 1. Preparation',
          '- K80 printer (LAN or USB)',
          '- 80mm thermal paper',
          '',
          '## 2. Setup steps',
          '1. Power on and connect the printer.',
          '2. Open Settings > Printers.',
          '3. Enter the printer IP address and save.',
        ].join('\n'),
        contentType: 'markdown',
        tags: ['printer', 'k80', 'hardware'],
        contextPaths: ['/settings/print'],
        viewCount: 150,
        helpfulCount: 12,
        notHelpfulCount: 1,
      ...
      },
      {
        ...
        type: 'USER_MANUAL',
        status: 'PUBLISHED',
        title: 'Configure VAT for your store',
        slug: 'cau-hinh-thue-vat-cho-cua-hang',
        summary: 'How to set up tax, service fees, and invoice templates.',
        content: [
          '# Configure VAT for your store',
          '',
          '## Goal',
          'Ensure invoices and reports use the correct tax settings.',
          '',
          '## Steps',
          '1. Go to Settings > Taxes and Fees.',
          '2. Create 8% or 10% VAT rates.',
          '3. Assign the tax rate to the correct product groups.',
        ].join('\n'),
        contentType: 'markdown',
        tags: ['tax', 'vat', 'invoice'],
        contextPaths: ['/settings/tax'],
        viewCount: 94,
        helpfulCount: 18,
        notHelpfulCount: 1,
      ...
      },
      {
        ...
        type: 'CHANGELOG',
        status: 'PUBLISHED',
        title: 'Added report filters by work shift',
        slug: 'cap-nhat-bo-loc-bao-cao-theo-ca-lam-viec',
        summary: 'This update adds filters by shift and staff member.',
        content: [
          '# Added report filters by work shift',
          '',
          '- Added filtering by work shift.',
          '- Added filtering by staff member.',
          '- Improved summary report loading speed.',
        ].join('\n'),
        contentType: 'markdown',
        tags: ['changelog', 'reports'],
        contextPaths: ['/reports'],
        viewCount: 55,
        helpfulCount: 9,
        notHelpfulCount: 0,
      ...
      },
      {
        ...
        type: 'BUSINESS_PLAYBOOK',
        status: 'PUBLISHED',
        title: 'Process returned orders',
        slug: 'quy-trinh-xu-ly-don-hoan',
        summary:
          'How to process failed deliveries, return stock, and sync inventory automatically.',
        content: '# Process returned orders',
        contentType: 'markdown',
        tags: ['orders', 'returns'],
        requiredPackage: 'PRO',
        requiredPackages: ['PRO'],
      ...
      },
      {
        ...
        type: 'USER_MANUAL',
        status: 'PUBLISHED',
        title: 'Track failed delivery orders',
        slug: 'cach-theo-doi-don-giao-that-bai',
        summary: 'Filter failed deliveries and follow up with customers effectively.',
        content: [
          '# Track failed delivery orders',
          '',
          '1. Go to Orders > Shipping.',
          '2. Filter by failed delivery status.',
          '3. Add notes and schedule a follow-up call.',
        ].join('\n'),
        contentType: 'markdown',
      ...
      },
      {
        ...
        slug: 'tao-tai-khoan-nhan-vien',
        summary: 'How to set permissions and create a new staff account.',
        content: '# Create a new staff account',
        contentType: 'markdown',
      ...
      },
      {
        ...
        type: 'USER_MANUAL',
        status: 'PUBLISHED',
        title: 'Get familiar with the admin dashboard',
        slug: 'lam-quen-giao-dien-quan-tri',
        summary: 'A quick overview of the main dashboard areas and menus.',
        content: [
          '# Get familiar with the admin dashboard',
          '',
          '- Revenue overview',
          '- Recent orders',
          '- Quick settings area',
      ...
      },
      {
        ...
        type: 'API_DOCS',
        status: 'PUBLISHED',
        title: 'Authenticate API requests with Bearer token',
        slug: 'huong-dan-xac-thuc-api-bang-bearer-token',
        summary: 'How to log in, get an access token, and send the Authorization header.',
        content: [
      ...
      },
      {
        ...
        type: 'API_DOCS',
        status: 'PUBLISHED',
        title: 'Article list endpoint reference',
        slug: 'tai-lieu-endpoint-lay-danh-sach-bai-viet',
        summary: 'Query params, pagination, and filters for the article listing API.',
        content: [
          '# Article list endpoint reference',
          '',
          'GET /api/help-center/articles',
          '',
          '## Query params',
  ...
  console.log(`Categories: ${categories.length + enCategories.length}`);
  console.log(`Articles: ${articles.length + 9}`);
}
